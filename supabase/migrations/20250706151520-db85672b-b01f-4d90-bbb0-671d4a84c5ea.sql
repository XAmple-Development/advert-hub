-- Add voting system (fixed version)
...
-- Create unique index for daily voting constraint
CREATE UNIQUE INDEX idx_votes_daily_unique 
ON public.votes (user_id, target_id, date_trunc('day', voted_at));
