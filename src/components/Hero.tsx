      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-center gap-8 mb-8">
          <button 
            ...
            className="text-white text-lg font-semibold border-b-2 border-primary pb-2"
          >
            Discord Bots
          </button>
          <button 
            onClick={() => navigate('/listings?type=server')}
            className="text-muted-foreground text-lg font-semibold hover:text-white transition-colors pb-2"
          >
            Discord Servers
          </button>
        </div>
